...
<nav>
    <div class="nav-wrapper">
      <div class="col s12">
        <a href="http://localhost/final-project/apie.php#!" class="breadcrumb">First</a>
        <a href="http://localhost/final-project/naujienos.php#!" class="breadcrumb">Second</a>
        <a href="http://localhost/final-project/naujienosdetaliau.php#!" class="breadcrumb">Sloths</a>
      </div>
    </div>
  </nav>
